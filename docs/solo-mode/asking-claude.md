...
The hive MCP server gives Claude Code direct access to your session history. In solo mode, it reads from your local SQLite database -- no running server required.
