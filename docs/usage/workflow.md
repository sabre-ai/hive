...
A day-in-the-life guide for using hive. In solo mode, everything stays local on your machine. In team mode, sessions are also pushed to the shared server -- but your daily workflow is identical.
